...
public class Principal {
    ...
    public static void main(String[] args) {
        ...
        String nome = JOptionPane.showInputDialog(null, "Qual o nome do titular da conta: ", "Cadastro do cliente", 3);
        ...
        ContaCorrente conCor = new ContaCorrente(numeroConta, nome);
        String usuario = "";
